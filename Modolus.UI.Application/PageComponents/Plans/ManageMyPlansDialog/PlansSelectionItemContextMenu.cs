...
{
    public class PlansSelectionItemContextMenu : PageObject
    {
        public PlansSelectionItemContextMenu(string name = null, WaitUIObject waitPageObject = null) : base(name, waitPageObject)
        {
        }
    }
}
